                            ...
                            <div className="img-testimonios2">
                                <div className="over-2">
                                    <div className="text-over">
                                        ...
                                        <p className="p-2">Gracias a esta página pude hacer que mi curriculun fuese más visible y atractivo para las
                                            empresas.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="img-testimonios3">
                                <div className="over-3">
                                    <div className="text-over">
                                        ...
                                        <p className="p-3">Pude consenguir una pega en mi comuna de algo que me apasiona, su ayuda con el currículum fue la
